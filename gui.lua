...
GUI.titleText = {153, 203, 255, 255, 1} ------- Color of title text                                   --
GUI.titleRect = {0, 0, 0, 255} ------------- Color of rectangle [title]                       --
GUI.optionText = {153, 203, 255, 255, 6} ------ Color of option text                                  --
GUI.optionRect = {0, 0, 0, 190} ------------ Color of option rectangles                       --
GUI.scroller = {100, 100, 100, 255} ----------- Color of active option                              --
